...
//---------------------------------------
// Proportional Gain
float Kp = 0; // Adjust this based on your system's response
//---------------------------------------
// Desired flow rate
float desiredFlowRate = 10.0; // Example value, set this according to your needs
//---------------------------------------
...
void readSensors() {
  ...
  Serial.println(desiredFlowRate);
}
