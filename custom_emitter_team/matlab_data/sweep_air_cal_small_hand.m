...
clear;
close all hidden;
name_ali = 'sweep_air_small_hand_alicat20';
name_esp = 'sweep_air_small_hand_esp';
...
legend("Alicat", Tesp.sensor(1))
grid on;
grid minor;% rowsToDeleteTesp = Tesp(:,2) < 94.815;
...
% Tesp = Tesp(abs(Tesp.flow33)>cutoffCut,:)
...
%%
% flows = transpose(Tesp.flow_3300);
...
% 
% x33 = Tali.mflow;
% y33 = (Tesp.flow33-Tali.mflow)./Tali.mflow*100;
% 
% x34 = Tali34mflowCut;
