...
file_names = ["step_response_100_alicat250", "step_response_100_esp"];
...
Tali([1:161, 7359:end],:) = [];
Tali.time_ms = (transpose((1:height(Tali))) .* 50E-3) + min(Tesp.time_ms);

%%
close all hidden;
figure(70)
plot(Tali.time_ms(1:2000),Tali.mflow(1:2000),"LineWidth",3)
hold on;
yline(100,"LineStyle","--")
set(gca,'fontsize', 20) 
title(["Custom Mass Flow Controller Step Response","with Setpoint = 100 SLPM"],"FontName","Arial","FontSize",30,"FontWeight","normal")


set(gcf,'Position',[100 100 800 600])
xlabel("Time (s)")
ylabel("Actual Emission (SLPM)")

annotation('textbox', [0.29, 0.4, 0.4, 0.1], 'String', "Rise Time = 14 s", 'FontSize',20, 'FitBoxToText','on')
annotation('textarrow', [0.29, 0.21], [0.58, 0.66],"LineWidth",2, 'String', 'Switch from large valve to small valve', 'FontSize',20)
grid on;
grid minor;
...
%%
postergrey = [136/255, 136/255, 136/255]
figure(88)
yline(100,":r","LineWidth",3)
hold on;
plot((Tesp.time_ms(17:100)-Tesp.time_ms(17))*10^-3, Tesp.total(17:100), "Color", cbBlue, "LineWidth",10)
area((Tesp.time_ms(17:100)-Tesp.time_ms(17))*10^-3, Tesp.total(17:100),"FaceColor",postergrey, "EdgeColor", postergrey, "LineWidth",1);
% hold on;
area((Tesp.time_ms(17:100)-Tesp.time_ms(17))*10^-3, Tesp.flow_3300(17:100),"FaceColor",cbGreen,"EdgeColor",cbGreen,"LineWidth",1);
% plot((Tesp.time_ms(17:100)-Tesp.time_ms(17))*10^-3, Tesp.total(17:100),"Color",postergrey,"LineWidth",3);
hold off;
xlim([0 (Tesp.time_ms(100)-Tesp.time_ms(17))*10^-3])
set(gca,'fontsize', 14) 
ylim([0 130])

set(gca,'fontsize', 20) 
title("Parallel Flow at 100 SLPM","FontName","Arial","FontSize",30,"FontWeight","normal")

legend("Setpoint","Total Flow", "Flow Through Small Valve", "Flow Through Large Valve")
xlabel("Time (s)")
...
% % hold on;
% % plot(Tesp.total)
% % yline([0.00275, 0.0275, 0.275, 2.75, 27.5, 50, 100, 200, 275])
% % hold off;
% % legend("Tali","Tesp")
...
% % 
% % tab_struct = struct('table', {table_0_00275, table_0_0275, table_0_275, table_2_75, table_27_5, table_50, table_100, table_275});
% % 
% % setpoints = [0.00275, 0.0275, 0.275, 2.75, 27.5, 50, 100, 275];
% % % rows_50 = [1587:8063];
% % rows_100  = [8636:15178];
...
%     scatter(setpoints, instErrs * 100, 60, 'b','o','filled');
    errorbar(setpoints, instErrs .* 100, minErrs.* 100, maxErrs.* 100,'o','MarkerEdgeColor',cbGreen,'MarkerFaceColor',cbGreen, 'MarkerSize', sz, 'LineWidth', lw);
    hold 
...
%     scatter(setpoints, runningErrs * 100, 60, 'r','o','filled');
    ...
    ylabel("Percent Error in Actual Emission")
    yticks("auto")
    set(gca,'fontsize', 15) 
    title("Error of Custom Mass Flow Controller Across 5 Orders of Magnitude",'FontSize',20)
    set(gcf,'Position',[100 100 800 600])
    grid on;
