...
file_name = 'parallel_all_run_1_mfc'; % Input file name from arduino_output_save folder
file_name_mfm = 'parallel_all_run_1_mfm'; % Input file name from arduino_output_save folder
...
table_data_mfm = table_from_csv(append("arduino_output_save/",file_name_mfm));

table_data_mfm_dropped = table_data_mfm(:,1:5);
table_data_mfc_dropped = table_data_mfc(:,[1:4,6]);
table_data_mfc_dropped_varname = renamevars(table_data_mfc_dropped,["Var6"],["Var5"]);
table_data = [ table_data_mfm_dropped; table_data_mfc_dropped_varname];
...
rows_0_0275 = [758:5778];
rows_0_275  = [6135:11721];
rows_27_5   = [19204:25252];
rows_100    = [26713:27935, 28091:28986];


table_0_0275 = table_data(rows_0_0275,:);
table_0_275 = table_data(rows_0_275,:);
% table_2_75 = table_data(rows_0_0275,:);
table_27_5 = table_data(rows_27_5,:);
table_100 = table_data(rows_100,:);

tab_struct = struct('table',{table_0_0275, table_0_275, table_27_5, table_100});
setpoints = [0.0275 0.275 27.5, 100];
